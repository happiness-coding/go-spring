...
public class ArticleViewRepositoryImpl implements ArticleViewRepository {
    ...
    static {
        // Example mock data
        ARTICLES.add(new ArticleView(1L, "first-article", "First Article", 1L, Arrays.asList("java", "spring")));
        ARTICLES.add(new ArticleView(2L, "second-article", "Second Article", 2L, Arrays.asList("spring", "api")));
        ARTICLES.add(new ArticleView(3L, "third-article", "Third Article", 1L, Arrays.asList("java", "backend")));

        ARTICLE_DETAILS.put("first-article", new ArticleDetailView(1L, "first-article", "First Article", "Content of first article", 1L, Arrays.asList("java", "spring")));
        ARTICLE_DETAILS.put("second-article", new ArticleDetailView(2L, "second-article", "Second Article", "Content of second article", 2L, Arrays.asList("spring", "api")));
        ARTICLE_DETAILS.put("third-article", new ArticleDetailView(3L, "third-article", "Third Article", "Content of third article", 1L, Arrays.asList("java", "backend")));
    }
