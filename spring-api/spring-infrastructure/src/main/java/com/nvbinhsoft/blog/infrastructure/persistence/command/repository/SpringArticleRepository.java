...
public class SpringArticleRepository implements ArticleRepository {
    ...
    public Optional<Article> findBySlug(Slug slug) {
        ArticleEntity articleEntity = entityManager.createQuery("SELECT a FROM ArticleEntity a WHERE a.slug = :slug", ArticleEntity.class)
    ...
    public List<Article> findAll() {
        List<ArticleEntity> articleEntities = entityManager.createQuery("SELECT a FROM ArticleEntity a", ArticleEntity.class).getResultList();
