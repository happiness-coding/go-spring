...
public class SpringCategoryRepository implements CategoryRepository {
    ...
    public Optional<Category> findBySlug(Slug slug) {
        CategoryEntity categoryEntity = entityManager.createQuery("SELECT c FROM CategoryEntity c WHERE c.slug = :slug", CategoryEntity.class)
    ...
    public List<Category> findAll() {
        List<CategoryEntity> categoryEntities = entityManager.createQuery("SELECT c FROM CategoryEntity c", CategoryEntity.class).getResultList();
