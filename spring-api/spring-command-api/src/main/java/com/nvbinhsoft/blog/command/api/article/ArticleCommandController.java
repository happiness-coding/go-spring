...
public class ArticleCommandController {
  ...
  public ResponseEntity<CommandResponse> createArticle(@RequestBody CreateArticleRequest request) {
    ...
    return new ResponseEntity<>(
        new CommandResponse(true, "Article created successfully", null), HttpStatus.CREATED);
  }

  @PutMapping("/{slug}")
  public ResponseEntity<CommandResponse> updateArticle(
      @PathVariable String slug, @RequestBody UpdateArticleRequest request) {
    if (!slug.equals(request.getSlug())) {
      return new ResponseEntity<>(
          new CommandResponse(false, "Slug in path does not match slug in request payload", null),
    ...
    return new ResponseEntity<>(
        new CommandResponse(true, "Article updated successfully", null), HttpStatus.OK);
  }
  ...
  public ResponseEntity<CommandResponse> publishArticle(@PathVariable Long articleId) {
    ...
    return new ResponseEntity<>(
        new CommandResponse(true, "Article published successfully", null), HttpStatus.OK);
  }
}
